...
/* Generated from ../O.Common/powerlink.dbd */
...
epicsShareExtern dset *pvar_dset_oplkAi;
...
epicsShareExtern dset *pvar_dset_oplkBo;
...
epicsShareExtern drvet *pvar_drvet_oplk;
...
epicsShareExtern void (*pvar_func_oplkRegister)(void);
...
epicsShareExtern int *pvar_int_oplkDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"oplkDebug", iocshArgInt, (void * const)pvar_int_oplkDebug},
	{NULL, iocshArgInt, NULL}
};

int powerlink_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/test/epics/modules/powerlink";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"powerlink_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    powerlink_registerRecordDeviceDriver(*iocshPpdbbase);
}
